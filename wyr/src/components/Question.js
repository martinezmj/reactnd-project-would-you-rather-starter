...
class Question extends Component {
    ...
    render() {
        ...
        console.log("found: " + !!questions[id]);
        if (!questions[id]) {
                    ...
                    !!this.props.user.answers[this.props.id]
                        ...
                        : (
                            <Fragment>
                                ...
                                <div><img src={users[questions[id].author].avatarURL} style={{width: "50px", height: "50px"}}/></div>
                                <h3>Would you rather...</h3>

                                <div>
                                    <input type="radio" id="optionOne" name="optionOne" value="optionOne" onChange={(ev) => this.answerChange(ev)} />
                                    <label htmlFor="optionOne">{questions[id].optionOne.text}</label>
                                    <input type="radio" id="optionTwo" name="optionTwo" value="optionTwo" onChange={(ev) => this.answerChange(ev)}/>
